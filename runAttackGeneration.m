...
[z_vector, attacker_measurement_map, ~] = vectorizeAndMapMeasurements(attacker_measurements, pmu_config, noise_params, struct('num_buses', size(bus,1), 'num_branches', size(mpc.branch,1), 'selection', config.MeasurementSelection));
